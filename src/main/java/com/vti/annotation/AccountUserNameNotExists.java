...
import com.vti.annotation.AccountUserNameNotExists.ListAccountValid;
import com.vti.validation.AccountUserNameNotExistsValidator;

@Target({ METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER, TYPE_USE })
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = { AccountUserNameNotExistsValidator.class })
@Repeatable(ListAccountValid.class)
